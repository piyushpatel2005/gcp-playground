...
class MeasInfo:
    ...
    def __init__(self, mi):
        ...
        # for item in self.measureTypes.values():
        #     print(item.name)
                    ...
                    if isinstance(mv[i].get('r'), dict):
                        ...
                        for j in range(len(mv[i].get('r'))):
                            self.measValues[len(self.measValues)] = MeasValue(mv[i].get('@measObjLdn'),
                                                                              ...
                                                                              mv[i].get('r')[j].get('@p'),
                                                                              mv[i].get('suspect'))
        # for item in self.measValues.values():
        #     print(item.value)
    ...
    def print(self):
        ...
        print('MeasureTypes length: {}'.format(len(self.measureTypes)))
        print('MeasValues length: {}'.format(len(self.measValues)))
...
class GPPXmlFlat:
    ...
    def convert_to_records(self, input_file, input_date_time, transformed_file):
        ...
        for i in range(len(self.measData)):
            ...
            # for info in md.measInfo.values():
            #     info.print()
    ...
    def convert_to_flat_records(self, input_file, input_date_time, transformed_file):
